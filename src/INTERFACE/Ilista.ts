export interface IList {
    ...
    removeAt(item:any): void // Remove um elemento em uma posição específico da lista

    // Acessar elementos

    get(index: any): any|null // Retorna o elemento em uma posição em uma posição específica da lista
    indexOf(intem: any): number // Retorna o indície da primeira ocorrência de um elemento na lista
